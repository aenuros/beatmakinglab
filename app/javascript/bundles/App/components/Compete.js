        ...
        <Row>
          <Col s={12} m={4}>
            <Card className='small'
              ...
              actions={[<a href='https://www.rocbattle.com'>rocbattle</a>]}>
          ...
          <Col s={12} m={4}>
            <Card className='small'
              ...
              actions={[<a href='https://www.illmuzik.com/beat-battles'>illmuzik</a>]}>
          ...
          <Col s={12} m={4}>
            <Card className='small'
              ...
              actions={[<a href='https://www.istandardproducers.com/showcase/producer-experience'>istandardproducers</a>]}>
          ...
          <Card className='small'
              ...
              actions={[<a href='https://battleofthebeatmakers.com'>battleofthebeatmakers</a>]}>
              Compete in Toronto!
      </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              ...
              actions={[<a href='http://beatroyale.com/'>beatroyale/</a>]}>
          ...
          <Card className='small'
              ...
              actions={[<a href='http://jaxbeatbattle.com'>jaxbeatbattle</a>]}>
             Compete in Florida!
          </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              ...
              actions={[<a href='http://freshproducestl.com'>freshproducestl</a>]}>
              Compete in St Louis!
          </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              ...
              actions={[<a href='http://www.thebeatacademy.com'>thebeatacademy</a>]}>
              Compete in London!
          </Card>
          </Col>
