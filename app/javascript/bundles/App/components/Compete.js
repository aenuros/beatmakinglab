        ...
        <Row>
          <Col s={12} m={4}>
            <Card className='small'
              ...
              actions={[<a href='https://www.rocbattle.com' target="_blank">rocbattle</a>]}>
              Vote on whose beat is better!
            </Card>
          </Col>
          <Col s={12} m={4}>
            <Card className='small'
              ...
              actions={[<a href='https://www.illmuzik.com/beat-battles' target="_blank">illmuzik</a>]}>
          ...
          <Col s={12} m={4}>
            <Card className='small'
              ...
              actions={[<a href='https://www.istandardproducers.com/showcase/producer-experience' target="_blank">istandardproducers</a>]}>
              Compete in NYC and other major cities!
            </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              header={<CardTitle image='http://cdn.shopify.com/s/files/1/1345/5155/t/5/assets/logo.png?15140930161716290694'></CardTitle>}
              actions={[<a href='https://battleofthebeatmakers.com' target="_blank">battleofthebeatmakers</a>]}>
              Compete in Toronto!
      </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              ...
              actions={[<a href='http://beatroyale.com/' target="_blank">beatroyale/</a>]}>
          ...
          <Card className='small'
              ...
              actions={[<a href='http://jaxbeatbattle.com' target="_blank">jaxbeatbattle</a>]}>
             Compete in Florida!
          </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              ...
              actions={[<a href='http://freshproducestl.com' target="_blank">freshproducestl</a>]}>
              Compete in St Louis!
          </Card>
          </Col>
          <Col s={12} m={4}>
          <Card className='small'
              ...
              actions={[<a href='http://www.thebeatacademy.com' target="_blank">thebeatacademy</a>]}>
              Compete in London!
          </Card>
          </Col>
